            ...
            <div class="card">
              ...
              <?php
                ...
                if(empty($_POST['search']) && empty($_COOKIE['search'])){
                  ...
                  $stmt = $pdo->prepare("SELECT * FROM categories WHERE name LIKE '%$search_key%' ORDER BY id DESC LIMIT $offset,$numOfRecs");
                  $stmt->execute();
                  $result = $stmt->fetchAll();
                }
              ?>
                ...
                <table class="table table-bordered">
                  ...
                  <?php
                    ...
                    <tr>
                      ...
                      <td><?php echo escape(substr($value['description'],0,200)); ?></td>
                      <td>
                        <a href="cat_edit.php?id=<?php echo $value['id']; ?>" class="btn btn-sm btn-warning">Edit</a>
