	...
	if(!empty($_SESSION['cart'])){
		...
		if($result){
			...
			foreach($_SESSION['cart'] as $key => $qty){
				...
				$result = $stmt->execute(
					array(':sale_order_id' => $saleOrderId,
						':product_id' => $id,
						':quantity' => $qty)
				);
...
<body>
	...
	<section class="order_details section_gap">
		<div class="container">
			<h3 class="title_confirmation" style="margin-bottom: 0px; !important">Thank you. Your order has been received.</h3>
